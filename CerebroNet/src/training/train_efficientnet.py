...
def train(params: dict) -> None:
    ...
    with mlflow.start_run(run_name="EfficientNet-B0"):
        ...
        best_f1      = 0.0
        patience_ctr = 0
        best_model_path = Path("models/artifacts/efficientnet_best.pth")
        ...
        report_path = Path(
            "models/artifacts/classification_report_efficientnet.txt"
        )
        ...
        metrics_path = Path("models/artifacts/metrics_efficientnet.json")
